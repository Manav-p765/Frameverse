...
export default function TodayPreview() {
    ...
    if (error) {
        return (
            <div className="rounded-2xl border border-red-500/20 bg-brand-pink/10 p-6 text-brand-pink">
    ...
    if (!stats) {
        return (
            <div className="rounded-2xl border border-border-color bg-white/5 p-8 text-center shadow-lg">
                ...
                <h3 className="text-lg font-medium text-text-primary">No activity yet today</h3>
    ...
    return (
        <div className="rounded-2xl border border-border-color bg-white/5 p-6 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-4">
                {/* GitHub Stat */}
                <div className="flex flex-col rounded-xl border border-border-color bg-bg-primary/20 p-4">
            ...
            {stats.caption && (
                <div className="mt-6">
                    ...
                    <div className="rounded-xl border border-border-color bg-bg-primary/40 p-4 text-sm leading-relaxed text-text-secondary">
                        {stats.caption}
                    </div>
                </div>
            )}
            ...
            {stats.imageUrl && (
                <div className="mt-4 flex items-center justify-between rounded-xl border border-border-color bg-bg-primary/20 p-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-sm font-medium text-text-primary">Stats Card Generated</p>
                            <p className="text-xs text-text-secondary">Ready for layout</p>
                        </div>
                    </div>
                    <a
                        href={stats.imageUrl}
                        target="_blank"
                        rel="noreferrer"
                        className="text-xs font-medium text-brand-purple hover:text-blue-300 transition-colors"
                    >
                        View Image
                    </a>
                </div>
...
function TodayPreviewSkeleton() {
    return (
        <div className="rounded-2xl border border-border-color bg-white/5 p-6 animate-pulse">
            <div className="mb-6 flex items-center justify-between">
