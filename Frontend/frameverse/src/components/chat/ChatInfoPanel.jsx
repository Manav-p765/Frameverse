...
export default function ChatInfoPanel({ chat, currentUserId, onClose }) {
  ...
  return (
    <div className="flex flex-col h-full min-h-0 bg-[#18181c]">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-[#2a2a30] flex-shrink-0 bg-[#18181c] z-10">
      ...
      <div className="px-4 py-4 border-b border-[#2a2a30] space-y-3">
        <div className="flex items-start gap-3">
          <svg className="text-[#5a5a6a] mt-0.5 flex-shrink-0" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="border-b border-[#2a2a30]">
          ...
          {chat.users?.map((user) => (
            <div key={user._id} className="flex items-center gap-3 px-4 py-2.5">
              <div className="w-9 h-9 rounded-full bg-[#2a2a30] overflow-hidden flex items-center justify-center flex-shrink-0">
                {user.profilePic ? (
            ...
            files.length === 0 ? (
              ...
              <div className="space-y-2">
                {files.map((msg) => (
                  ...
                  >
                    <svg className="text-[#9a9aaa] flex-shrink-0" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      <path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z" /><polyline points="13 2 13 9 20 9" />
                    </svg>
                    <div className="flex-1 min-w-0">
